...
# # Save the model
# pickle.dump(shap_model, open('./Models/RF_default.pkl', 'wb'))

# Get the model
shap_model = pickle.load(open('./Models/RF_default.pkl', 'rb'))
print('Model loaded')
...
plt.savefig('RF_shap_builtin_summary_plot.png', bbox_inches='tight')
