...
parser.add_argument('--pretrained_model_path', type=str, default='./Models/mst_AWB_940_t50.pth')
parser.add_argument('--data_root', type=str, default='../../../datasets/MobileDatasets/OnSemi-custom-RGB-NIR/aligned/')
parser.add_argument('--outf', type=str, default='../../../datasets/MobileDatasets/OnSemi-custom-RGB-NIR/rec_50/')
...
def test(model, test_path, save_path):
    ...
    for i in range(len(img_path_name)):
        ...
        nir_path = img_path_name[i].replace('_RGB.png','_NIR.png')
