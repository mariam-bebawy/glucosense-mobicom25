...
def main(data_root, file_train, file_test):
    ...
    # X_train = cp.array(X_train_scaled)
    ...
    # }
    num_round = 100
    # dtrain = xgb_model.DMatrix(X_train_scaled, y_train)
    # xgb_model = xgb_model.train(param, dtrain, num_round)
    
    
    xgb_model = XGBRegressor(obejctive='reg:squarederror', device='cuda')
